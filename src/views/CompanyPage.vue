...
<template>
    ...
    <div class="w-full mt-20 flex flex-wrap gap-[2%]">
      ...
      >
        ...
        <div class="w-full mt-[100px] p-4">
          ...
          <p class="text-center mt-6">
            Our vision is to streamline our personal values through every aspect
            of our business. From the quality of products we produce, to the
            level of customer service we provide, we want to demonstrate our
            values: do good, be good, exceed good.
          </p>
        </div>
      </div>
    </div>
  ...
  >
    ...
    >
      <h4 class="text-6xl font-bold custom-text-red">Competitive Advantage</h4>
  ...
  <Cta about_cta />
  <!-- partners -->
  <div class="mt-10 w-full h-fit p-20 client-section">
    <div
    ...
    >
      <div class="w-full flex flex-col justify-center">
        ...
        <p class="text-center mt-6 text-xl">
          ...
          Lodges | Commercial Laundries | Dry Cleaners | Universities & Schools
          | Factories | Restaurants | Plastic Recyclers | Water & Beverage
          Bottlers.
        </p>
      </div>
      <div
